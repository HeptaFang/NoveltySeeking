...
task_names = {...
    ...
    % 'SalinePostTask_cortex','SalinePreTask_cortex', 'SalinePreTask_full', ...
    % 'SalinePostRestOpen_cortex', 'SalinePreRestOpen_cortex', ...
    % 'SalinePostRestClose_cortex', 'SalinePreRestClose_cortex', ...
    % 'SalinePreRestOpen_full', 'SalinePreRestClose_full', ...
